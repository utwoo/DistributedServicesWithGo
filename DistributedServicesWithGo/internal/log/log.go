...
// NewLog we first set defaults for the configs the caller didn’t
...
// and restoring a log. Reader() uses an io.MultiReader() call to concatenate the segments
// stores. The segment stores are wrapped by the originReader type for two
