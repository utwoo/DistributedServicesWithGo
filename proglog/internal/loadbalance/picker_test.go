...
// state with available subconnections. balancer.ErrNoSubConnAvailable instructs gRPC
// to block the client’s RPCs until the picker has an available subconnection to
// handle them.
